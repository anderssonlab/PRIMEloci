...
#' sliding_windows <- genomewide_sliding_window_chr(gr_chr, slide_by = 20, expand_by = 200) # nolint: line_length_linter.
#' @import GenomicRanges
#' @import IRanges
#' @export
genomewide_sliding_window_chr <- function(gr_per_chr, slide_by = 20, expand_by = 200) { # nolint: line_length_linter.
...
#' genomewide_sliding_windows <- genomewide_sliding_window(gr, slide_by = 20, expand_by = 200) # nolint: line_length_linter.
#' @import GenomicRanges
#' @import IRanges
#' @import parallel
#' @export
