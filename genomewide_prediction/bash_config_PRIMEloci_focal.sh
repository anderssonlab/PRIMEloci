...
CTSS_RSE_RDS="PRIMEloci_results/ctss_rse.rds"
REGION_RDS="PRIMEloci_results/K562-10pct_on_PRIMEloci_pred_all_K562_C1_combined_thresh0.75_d0.1_extfromthick.rds"
OUTPUT_DIR="PRIMEloci_results"
...
MODEL_PATH=$(Rscript -e 'cat(system.file("model", "PRIMEloci_GM12878_model_1.0.sav", package = "PRIMEloci"))')
