...
ocr_train_gr <- CAGEfightR::assignTxType(ocr_train_gr,
                                         txModels = txdb)
writeLines("\nocr_train_aug_gr Annotation")
ocr_train_aug_gr <- CAGEfightR::assignTxType(ocr_train_aug_gr,
                                             txModels = txdb)
writeLines("\nocr_test_gr Annotation")
ocr_test_gr <- CAGEfightR::assignTxType(ocr_test_gr,
                                        txModels = txdb)
writeLines("\nocrlike_neg_train_gr Annotation")
ocrlike_neg_train_gr <- CAGEfightR::assignTxType(ocrlike_neg_train_gr,
                                                 txModels = txdb)
writeLines("\nocrlike_neg_train_aug_gr Annotation")
ocrlike_neg_train_aug_gr <- CAGEfightR::assignTxType(ocrlike_neg_train_aug_gr,
                                                     txModels = txdb)
writeLines("\nocrlike_neg_test_gr Annotation")
ocrlike_neg_test_gr <- CAGEfightR::assignTxType(ocrlike_neg_test_gr,
                                                txModels = txdb)
