...
# Debugging: Print importance values
print("Positive Predictions Importance Values:")
print(importance_pos_pred_mean)
print("Negative Predictions Importance Values:")
print(importance_neg_pred_mean)

# Handle zero or negative importances for plotting
if importance_pos_pred_mean.max() <= 0:
    importance_pos_pred_mean += abs(importance_pos_pred_mean.min()) + 1e-6
if importance_neg_pred_mean.max() <= 0:
    importance_neg_pred_mean += abs(importance_neg_pred_mean.min()) + 1e-6
